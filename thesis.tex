...
The second part of the thesis reports a series of quantitative studies that investigate to what extent observed behaviour of the first studies are due to the access costs of the information sources involved. When people copy from one source and IAC increases, people make fewer switches to look at this source, and instead enter what they have memorised. This makes people more efficient, but slightly increases errors. A planned study aims to further investigate switching behaviour when people have to retrieve the information from multiple sources.

The final part of the thesis then reports studies that explore if design interventions can make people adopt more desirable strategies, i.e. strategies that minimise switching between entering data and looking up the required data. 
...
\fbox{\begin{minipage}{\textwidth}
\subsubsection{Chapter outline}
In this chapter, I describe two lab experiments that investigate to what extent IACs of information sources influence people's switching strategies, speed and accuracy.

The purpose of Study 3 was to test whether the effect of IAC on copying colours from one source, as found in previous studies, extends to copying numbers. A part of the data was collected by Katherine Corneilson, an affiliate undergraduate student at UCL. I designed and implemented the study, collected the remainder of the data, and conducted the analyses.

I describe a planned Study 4 that investigates the effect of IAC on people's strategies when entering and looking up information from multiple sources.
...
In this chapter I describe two planned future studies that explore if design interventions can make people adopt more desirable strategies, i.e. strategies that minimise switching between entering data and looking up the required data. The details of the setup will be further determined by the outcome of the previous studies, but here I describe the intended goals of these two studies.
